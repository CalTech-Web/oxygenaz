  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1A1A2E] via-[#1A1A2E] to-[#FF6B6B] py-20 md:py-28 grain">
        ...
        <div className="absolute -bottom-20 -left-20 w-[300px] h-[300px] rounded-full bg-[#FF6B6B]/20 blur-[80px] pointer-events-none" />
      ...
      <section className="py-16 md:py-20 bg-[#FFF8F0]">
        <div className="max-w-[1140px] mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold font-[var(--font-display)] text-[#1A1A2E] tracking-tight accent-underline-center mb-4">
