          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-4">
                <a
                  href={SITE.phoneHref}
                  className="flex-1 flex items-center justify-center gap-2 rounded-lg bg-brand-gold px-6 py-3 font-semibold text-brand-bg hover:bg-brand-gold-light transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 rounded-lg border-2 border-brand-gold px-6 py-3 font-semibold text-brand-gold hover:bg-brand-gold hover:text-brand-bg transition-colors"
                >
