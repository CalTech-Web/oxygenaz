    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#7A7A7A] text-lg md:text-xl leading-relaxed font-light">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#EDF2F9] to-white">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-[#10173E] mb-6 accent-underline">
                The Founder of Oxygen Wellness & Physical Therapy
              </h2>
              <p className="text-[#7A7A7A] text-lg mb-4 leading-relaxed font-light">
              ...
              <p className="text-[#7A7A7A] text-lg mb-8 leading-relaxed font-light">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-[1140px] mx-auto px-4">
          ...
          <p className="text-[#7A7A7A] text-lg md:text-xl text-center max-w-3xl mx-auto leading-relaxed font-light">
