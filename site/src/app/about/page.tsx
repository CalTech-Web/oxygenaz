...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden grain">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-br from-[#1A1A2E]/90 via-[#1A1A2E]/88 to-[#FF6B6B]/80" />
        </div>

        {/* Decorative orbs */}
        <div className="absolute -top-20 -right-20 w-[400px] h-[400px] rounded-full bg-[#FF6B6B]/8 blur-[100px] pointer-events-none" />
        <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] rounded-full bg-[#FF6B6B]/15 blur-[120px] pointer-events-none" />
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-[#6B7280] text-lg md:text-xl mb-4 leading-relaxed font-light">
      ...
      {/* Founder Section */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#FFF8F0] to-white">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold font-[var(--font-display)] tracking-tight text-[#1A1A2E] mb-6 accent-underline">
                The Founder of Oxygen Wellness & Physical Therapy
              </h2>
              <p className="text-[#6B7280] text-lg mb-4 leading-relaxed font-light">
              ...
              <p className="text-[#6B7280] text-lg mb-8 leading-relaxed font-light">
              ...
              <a
                ...
                className="inline-block bg-gradient-to-r from-[#FF6B6B] to-[#E84545] text-white rounded-full px-8 py-4 font-black text-sm uppercase tracking-wider shadow-[0_8px_30px_rgba(255,107,107,0.25)] hover:scale-105 hover:shadow-[0_0_30px_rgba(255,107,107,0.3)] transition-all duration-300"
              >
      ...
      >
        {/* Multi-layer overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#1A1A2E]/82 via-[#1A1A2E]/88 to-[#1A1A2E]/95" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#FF6B6B]/12 to-transparent" />

        {/* Decorative orb */}
        <div className="absolute -top-20 -right-20 w-[400px] h-[400px] rounded-full bg-[#FF6B6B]/10 blur-[100px] pointer-events-none" />
        ...
        <div className="relative z-10 text-center max-w-[1140px] mx-auto px-4 py-16 md:py-20">
          ...
          >
            It&apos;s All About <span className="text-[#FF6B6B]">YOU</span>
          </h2>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-[1140px] mx-auto px-4">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold font-[var(--font-display)] tracking-tight text-[#1A1A2E] mb-6 text-center accent-underline-center">
            Blending Tradition with Innovation
          </h2>
          <p className="text-[#6B7280] text-lg md:text-xl text-center max-w-3xl mx-auto leading-relaxed font-light">
