  ...
  return (
    <>
      ...
      <section className="relative min-h-[500px] flex items-center justify-center grain">
        ...
        <div className="absolute -bottom-20 -left-20 w-[300px] h-[300px] rounded-full bg-[#061527]/15 blur-[80px] pointer-events-none" />
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <h2 className="font-[var(--font-display)] text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#061527] tracking-tight mb-6">
                What is Physical Therapy?
              </h2>
              ...
              <ul className="space-y-2 mb-8">
                {techniques.map((technique) => (
                  <li key={technique} className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-[#0066B3] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-[#718096]">{technique}</span>
                  </li>
                ))}
              </ul>
              <Link
                href="/contact"
                className="inline-block bg-gradient-to-r from-[#0066B3] to-[#00518F] text-white rounded-full px-8 py-4 font-black text-sm uppercase tracking-wider shadow-[0_8px_30px_rgba(0,180,216,0.25)] hover:scale-105 hover:shadow-[0_0_30px_rgba(0,180,216,0.4)] transition-all duration-300"
              >
                BOOK APPOINTMENT
              </Link>
            </div>
      ...
      <section className="py-16 md:py-20 bg-[#F0F5FA]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="font-[var(--font-display)] text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#061527] tracking-tight mb-8 text-center">
            What to Expect During a Physical Therapy Appointment
          </h2>
          <ul className="max-w-3xl mx-auto space-y-4">
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#0066B3] shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-[#718096] text-lg">You can choose between our 25 or 55 minute session</span>
            </li>
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#0066B3] shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-[#718096] text-lg">You will be in a public space</span>
            </li>
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#0066B3] shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-[#718096] text-lg">Wear comfortable clothing and be prepared to move around</span>
            </li>
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#0066B3] shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-[#718096] text-lg">Get a free Core Service of your choice</span>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="relative overflow-hidden bg-gradient-to-br from-[#0066B3] to-[#061527] rounded-2xl p-8 text-center">
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/contact"
                className="inline-block bg-white text-[#061527] rounded-full px-8 py-4 font-black text-sm uppercase tracking-wider shadow-[0_8px_30px_rgba(0,0,0,0.15)] hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all duration-300"
              >
                BOOK APPOINTMENT
              </Link>
            </div>
...
function PTFAQSection({ faqs }: { faqs: { question: string; answer: string }[] }) {
  return (
    <section className="py-16 md:py-20 bg-[#F0F5FA]">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="font-[var(--font-display)] text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#061527] tracking-tight accent-underline-center mb-8 text-center">
...
function PTFAQItem({ question, answer }: { question: string; answer: string }) {
  return (
    <details className="group bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.06)] overflow-hidden border-l-4 border-transparent hover:border-[#0066B3] hover:shadow-[0_8px_30px_rgba(0,0,0,0.1)] transition-all duration-300">
      <summary className="flex items-center justify-between gap-4 px-6 py-4 cursor-pointer list-none">
        <span className="text-lg font-semibold text-[#061527] group-hover:text-[#0066B3] transition-colors">
          {question}
        </span>
        <svg
          className="w-5 h-5 text-[#0066B3] shrink-0 transition-transform group-open:rotate-180"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <div className="px-6 pb-4">
        <p className="text-[#718096] leading-relaxed">{answer}</p>
      </div>
    </details>
  );
}
