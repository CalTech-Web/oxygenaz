...
const idealFor = [
  "Athletes looking to speed up post-training recovery",
  "Individuals recovering from intense exercise or competition",
  "People dealing with poor circulation in the legs",
  "Those managing lymphedema or chronic swelling",
];
