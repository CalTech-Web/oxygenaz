...
const idealFor = [
  "Those seeking science-backed anti-aging solutions",
  "People wanting to improve skin health, elasticity, and tone",
  "Individuals focused on cellular repair and regeneration",
  "Anyone looking to enhance vitality and overall energy levels",
];
