...
const idealFor = [
  ...
  "Chronic pain sufferers looking for natural relief",
  "Post-workout recovery seekers wanting to reduce soreness",
  "Anyone looking to boost energy and mood naturally",
];
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap">
            ...
            {service.promo && (
              <div className="inline-flex items-center gap-2 bg-brand-elevated border border-brand-border rounded-full px-5 py-2.5">
                ...
                <span className="text-brand-muted font-medium">{service.promo}</span>
              </div>
            )}
          </div>
        </div>
