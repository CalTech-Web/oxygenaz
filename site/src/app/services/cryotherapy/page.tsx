    ...
    <>
      ...
      <section className="py-10 bg-[#EDF2F9]">
        <div className="max-w-[1140px] mx-auto px-4 flex flex-wrap items-center justify-center gap-4">
          {service.walkIn && (
            <span className="bg-[#004AAD] text-white rounded-full px-6 py-2 text-sm font-bold uppercase">
              Walk-ins Welcome
            </span>
          )}
          {service.promo && (
            <span className="bg-white text-[#10173E] rounded-full px-6 py-2 text-sm font-bold border border-[#C3C3C4]">
              {service.promo}
            </span>
          )}
        </div>
