...
const idealFor = [
  "Those experiencing dehydration or needing rapid rehydration",
  "People looking for immune system support during cold and flu season",
  "Individuals recovering from a hangover or jet lag",
  "Anyone dealing with vitamin deficiency or nutrient absorption issues",
];
