...
const idealFor = [
  "Those experiencing low energy and chronic fatigue",
  "People dealing with mental fog and difficulty concentrating",
  "Individuals seeking enhanced recovery after physical activity",
  "Anyone focused on general wellness and vitality",
];
