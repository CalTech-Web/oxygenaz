...
export default function PrivacyPolicyPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-[#10173E] py-16 md:py-20">
        <div className="max-w-[1140px] mx-auto px-4 text-center">
          <h1
            className="text-[60px] font-extrabold text-white leading-tight"
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8 text-[#7A7A7A] leading-relaxed">
            <div>
              <h2 className="text-2xl font-extrabold text-[#10173E] mb-3">
                Introduction
              </h2>
              <p>
            ...
            <div>
              ...
              <h3 className="text-lg font-bold text-[#10173E] mb-2">
            ...
            <div>
              ...
              <address className="mt-3 not-italic space-y-1">
                <p className="font-bold text-[#10173E]">Oxygen Wellness LLC</p>
                ...
                <p>
                  ...
                  <a
                    ...
                    className="text-[#004AAD] hover:text-[#0053DA] underline"
                  >
