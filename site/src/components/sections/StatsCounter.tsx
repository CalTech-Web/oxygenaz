...
export default function StatsCounter() {
  return (
    <section className="relative bg-[#061527] py-16 md:py-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-[#0066B3]/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full bg-[#061527]/10 blur-[100px] pointer-events-none" />
