...
export default function AboutSection() {
  return (
    <section className="relative py-20 md:py-28 bg-white overflow-hidden">
      ...
      <div className="absolute top-1/4 right-[-10%] w-[500px] h-[500px] rounded-full bg-[#00B4D8]/8 blur-[120px] pointer-events-none" />
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={fadeInLeft}>
            <h2 className="font-[var(--font-display)] text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0B2447] leading-[1.1] tracking-tight">
              It&apos;s All About{" "}
              <span className="text-gradient-vibrant">YOU</span>
            </h2>
            <div className="h-1 w-20 rounded-full bg-gradient-to-r from-[#00B4D8] to-[#0B2447] mt-6" />
          </motion.div>

          {/* Right - Content + Dr. card */}
          <motion.div variants={fadeInRight}>
            <p className="text-[#5A6878] text-lg leading-relaxed mb-8">
            ...
            {/* Dr. Borman card */}
            <div className="flex items-center gap-4 bg-[#F5F7FA] rounded-2xl p-5 mb-8">
              <Image
              ...
              />
              <div>
                <p className="font-bold text-[#0B2447]">Dr. Clint Borman, DPT</p>
                <p className="text-sm text-[#6B7B8D]">Owner & Physical Therapist - 25+ Years Experience</p>
              </div>
            </div>
