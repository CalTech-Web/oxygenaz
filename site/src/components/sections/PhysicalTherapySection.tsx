...
export default function PhysicalTherapySection() {
  return (
    <section className="relative py-20 md:py-28 bg-gradient-to-br from-[#F0F5FA] to-white overflow-hidden">
      {/* Background accents */}
      <div className="absolute top-[-5%] right-[-10%] w-[500px] h-[500px] rounded-full bg-[#0066B3]/5 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[-5%] left-[-5%] w-[400px] h-[400px] rounded-full bg-[#061527]/5 blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 lg:px-20">
        ...
        >
          ...
          <motion.div variants={fadeInLeft} className="relative">
            ...
            <div className="absolute -top-4 -left-4 w-full h-full rounded-2xl border-2 border-[#0066B3]/20" />
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.15)]">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-[#061527]/40 to-transparent" />
              {/* Top accent line */}
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#0066B3] to-[#061527]" />
            </div>

            {/* Floating badge */}
            <div className="absolute -bottom-5 -right-3 lg:-right-6 bg-gradient-to-r from-[#0066B3] to-[#00518F] text-white rounded-xl px-5 py-3 shadow-[0_8px_30px_rgba(0,180,216,0.35)]">
          ...
          <motion.div variants={fadeInRight}>
            ...
            <div className="h-1 w-20 rounded-full bg-gradient-to-r from-[#0066B3] to-[#061527] mb-10" />
              ...
              {features.map((feature) => (
                <div key={feature.title} className="flex gap-4 group">
                  <div className="shrink-0 mt-1">
                    <div className="w-8 h-8 rounded-full bg-[#0066B3]/10 flex items-center justify-center group-hover:bg-[#0066B3]/20 transition-colors">
            ...
            <Link
              ...
              className="inline-block bg-gradient-to-r from-[#0066B3] to-[#00518F] text-white rounded-full px-8 py-4 text-sm font-black uppercase tracking-wider hover:scale-105 hover:shadow-[0_0_30px_rgba(0,180,216,0.4)] transition-all duration-300 shadow-[0_8px_30px_rgba(0,180,216,0.25)] mb-8"
            >
              Learn More About Physical Therapy
            </Link>

            {/* Consultation CTA card */}
            <div className="relative bg-[#061527] rounded-xl p-6 overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 rounded-full bg-[#0066B3]/10 blur-[40px] pointer-events-none" />
              ...
              <Link
                href="/contact"
                className="relative inline-block border-2 border-[#0066B3] text-[#0066B3] rounded-full px-8 py-3 text-sm font-black uppercase tracking-wider hover:bg-[#0066B3] hover:text-white hover:scale-105 transition-all duration-300"
              >
