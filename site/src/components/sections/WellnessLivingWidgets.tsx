      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <motion.div variants={itemVariants} className="gradient-border-wrap shadow-[0_8px_40px_rgba(0,102,179,0.2)]">
            <h3 className="text-white text-xl font-bold text-center mb-3">Wellness Services</h3>
            <div
              ref={widget1Ref}
          ...
          <motion.div variants={itemVariants} className="gradient-border-wrap shadow-[0_8px_40px_rgba(0,102,179,0.2)]">
            <h3 className="text-white text-xl font-bold text-center mb-3">Sports Medicine / Physical Therapy</h3>
            <div
              ref={widget2Ref}
              className="bg-white p-5 min-h-[200px]"
            />
