      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-10">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-brand-muted mb-6 max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-brand-surface border border-brand-border px-6 py-3 font-semibold text-brand-white hover:border-brand-gold/40 transition-colors"
              >
