...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-[#1A1A2E] to-[#0f0f1e]">
      {/* ── Gradient line at top ── */}
      <div className="h-[3px] bg-gradient-to-r from-transparent via-[#FF6B6B]/80 to-transparent" />
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="mt-6 space-y-3">
              <a
                href={SITE.phoneHref}
                className="group flex items-center gap-3 text-sm text-white/70 transition-colors hover:text-[#FF6B6B]"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/5 group-hover:bg-[#FF6B6B]/15 transition-colors">
              ...
              <a
                ...
                className="group flex items-center gap-3 text-sm text-white/70 transition-colors hover:text-[#FF6B6B]"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/5 group-hover:bg-[#FF6B6B]/15 transition-colors shrink-0">
          ...
          <div>
            <h3 className="text-base font-black uppercase tracking-wider text-[#FF6B6B]">
              Download Our App
            </h3>
                ...
                <li key={item.href + item.label}>
                  {item.external ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-white/70 transition-all hover:text-[#FF6B6B] hover:translate-x-1 inline-block"
                    >
                      {item.label}
                    </a>
                  ) : (
          ...
          <div>
            ...
            {/* Follow Us */}
            <h3 className="mt-8 text-base font-black uppercase tracking-wider text-[#FF6B6B]">
              Follow Us
            </h3>
            <div className="mt-4 flex gap-3">
              {socialLinks.map(({ label, href, icon: Icon }) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={label}
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-white/30 text-white transition-all duration-300 hover:bg-gradient-to-r hover:from-[#FF6B6B] hover:to-[#FF8C42] hover:text-white hover:border-transparent hover:shadow-[0_0_20px_rgba(255,107,107,0.4)] hover:scale-110"
                >
      ...
      {/* ── Bottom Bar ── */}
      <div className="h-px bg-gradient-to-r from-transparent via-[#FF6B6B]/20 to-transparent mx-4 lg:mx-20" />
